...
#    h.plot_tags_aps( r"./a")
    ...
    #  House C
    house_dir = r"../../ble-accelerometer-indoor-localisation-measurements/house_C/metadata"
    experiment_dir = r"../../ble-accelerometer-indoor-localisation-measurements/house_C/experiments/fingerprint_floor"
